...
export function Footer({content,local=false}:{content:Content;local?:boolean}){return <footer className="wrap footer"><span>{content.name||content.brand} © 2026</span><span>带着好奇心，继续设计。</span>{content.previewMode&&<a href="/edit">{local?'继续编辑本机草稿':'编辑内容草稿'} ↗</a>}</footer>}
