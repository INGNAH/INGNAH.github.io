...
export default function NotFound(){return <main className="wrap resume"><div className="eyebrow">404 / 页面未找到</div><h1>这个页面暂时不在这里。</h1><p>回到作品列表，继续看看。</p><a className="primary" href="/#projects">返回作品列表 ↗</a></main>}
